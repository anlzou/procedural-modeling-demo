...
/** Virtual aquarium boundary for fish on the open sea */
export interface VirtualAquarium {
  /** Center of the virtual aquarium */
  center: THREE.Vector3
  /** Half-size (x, y, z) */
  halfSize: THREE.Vector3
  /** Y coordinate of the water surface (aligned with ocean) */
  surfaceY: number
