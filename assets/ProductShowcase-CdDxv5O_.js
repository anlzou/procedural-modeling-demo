import{An as e,B as t,Bn as n,Cr as r,P as i,Pr as a,Rr as o,Tr as s,Un as c,_n as l,_t as u,d,ft as f,g as p,gn as m,gt as h,h as g,hr as ee,i as te,jr as _,mr as v,n as ne,nr as y,nt as b,o as re,pr as ie,pt as ae,r as oe,t as x,tt as S,u as se,ur as C,vt as ce,wn as w,xr as le,zn as T}from"./CSS3DRenderer-uzm-dSlc.js";import{n as ue,t as de}from"./OrbitControls-ErrH83oj.js";var E={name:`CopyShader`,uniforms:{tDiffuse:{value:null},opacity:{value:1}},vertexShader:`
		...
		}`},D=class{constructor(){this.isPass=!0,this.enabled=!0,this.needsSwap=!0,this.clear=!1,this.renderToScreen=!1}setSize(){}render(){console.error(`THREE.Pass: .render() must be implemented in derived pass.`)}dispose(){}},O=new f(-1,1,1,-1,0,1),k=new class extends d{constructor(){super(),this.setAttribute(`position`,new i([-1,3,0,-1,-1,0,3,-1,0],3)),this.setAttribute(`uv`,new i([0,2,0,0,2,0],2))}},A=class{constructor(e){this._mesh=new S(k,e)}dispose(){this._mesh.geometry.dispose()}render(e){e.render(this._mesh,O)}get material(){return this._mesh.material}set material(e){this._mesh.material=e}},j=class extends D{constructor(t,n=`tDiffuse`){super(),this.textureID=n,this.uniforms=null,this.material=null,t instanceof l?(this.uniforms=t.uniforms,this.material=t):t&&(this.uniforms=e.clone(t.uniforms),this.material=new l({name:t.name===void 0?`unspecified`:t.name,defines:Object.assign({},t.defines),uniforms:this.uniforms,vertexShader:t.vertexShader,fragmentShader:t.fragmentShader})),this._fsQuad=new A(this.material)}render(e,t,n){this.uniforms[this.textureID]&&(this.uniforms[this.textureID].value=n.texture),this._fsQuad.material=this.material,this.renderToScreen?(e.setRenderTarget(null),this._fsQuad.render(e)):(e.setRenderTarget(t),this.clear&&e.clear(e.autoClearColor,e.autoClearDepth,e.autoClearStencil),this._fsQuad.render(e))}dispose(){this.material.dispose(),this._fsQuad.dispose()}},M=class extends D{constructor(e,t){super(),this.scene=e,this.camera=t,this.clear=!0,this.needsSwap=!1,this.inverse=!1}render(e,t,n){let r=e.getContext(),i=e.state;i.buffers.color.setMask(!1),i.buffers.depth.setMask(!1),i.buffers.color.setLocked(!0),i.buffers.depth.setLocked(!0);let a,o;this.inverse?(a=0,o=1):(a=1,o=0),i.buffers.stencil.setTest(!0),i.buffers.stencil.setOp(r.REPLACE,r.REPLACE,r.REPLACE),i.buffers.stencil.setFunc(r.ALWAYS,a,4294967295),i.buffers.stencil.setClear(o),i.buffers.stencil.setLocked(!0),e.setRenderTarget(n),this.clear&&e.clear(),e.render(this.scene,this.camera),e.setRenderTarget(t),this.clear&&e.clear(),e.render(this.scene,this.camera),i.buffers.color.setLocked(!1),i.buffers.depth.setLocked(!1),i.buffers.color.setMask(!0),i.buffers.depth.setMask(!0),i.buffers.stencil.setLocked(!1),i.buffers.stencil.setFunc(r.EQUAL,1,4294967295),i.buffers.stencil.setOp(r.KEEP,r.KEEP,r.KEEP),i.buffers.stencil.setLocked(!0)}},N=class extends D{constructor(){super(),this.needsSwap=!1}render(e){e.state.buffers.stencil.setLocked(!1),e.state.buffers.stencil.setTest(!1)}},fe=class{constructor(e,n){if(this.renderer=e,this._pixelRatio=e.getPixelRatio(),n===void 0){let r=e.getSize(new T);this._width=r.width,this._height=r.height,n=new c(this._width*this._pixelRatio,this._height*this._pixelRatio,{type:t}),n.texture.name=`EffectComposer.rt1`}else this._width=n.width,this._height=n.height;this.renderTarget1=n,this.renderTarget2=n.clone(),this.renderTarget2.texture.name=`EffectComposer.rt2`,this.writeBuffer=this.renderTarget1,this.readBuffer=this.renderTarget2,this.renderToScreen=!0,this.passes=[],this.copyPass=new j(E),this.copyPass.material.blending=0,this.timer=new w}swapBuffers(){let e=this.readBuffer;this.readBuffer=this.writeBuffer,this.writeBuffer=e}addPass(e){this.passes.push(e),e.setSize(this._width*this._pixelRatio,this._height*this._pixelRatio)}insertPass(e,t){this.passes.splice(t,0,e),e.setSize(this._width*this._pixelRatio,this._height*this._pixelRatio)}removePass(e){let t=this.passes.indexOf(e);t!==-1&&this.passes.splice(t,1)}isLastEnabledPass(e){for(let t=e+1;t<this.passes.length;t++)if(this.passes[t].enabled)return!1;return!0}render(e){this.timer.update(),e===void 0&&(e=this.timer.getDelta());let t=this.renderer.getRenderTarget(),n=!1;for(let t=0,r=this.passes.length;t<r;t++){let r=this.passes[t];if(r.enabled!==!1){if(r.renderToScreen=this.renderToScreen&&this.isLastEnabledPass(t),r.render(this.renderer,this.writeBuffer,this.readBuffer,e,n),r.needsSwap){if(n){let t=this.renderer.getContext(),n=this.renderer.state.buffers.stencil;n.setFunc(t.NOTEQUAL,1,4294967295),this.copyPass.render(this.renderer,this.writeBuffer,this.readBuffer,e),n.setFunc(t.EQUAL,1,4294967295)}this.swapBuffers()}M!==void 0&&(r instanceof M?n=!0:r instanceof N&&(n=!1))}}this.renderer.setRenderTarget(t)}reset(e){if(e===void 0){let t=this.renderer.getSize(new T);this._pixelRatio=this.renderer.getPixelRatio(),this._width=t.width,this._height=t.height,e=this.renderTarget1.clone(),e.setSize(this._width*this._pixelRatio,this._height*this._pixelRatio)}this.renderTarget1.dispose(),this.renderTarget2.dispose(),this.renderTarget1=e,this.renderTarget2=e.clone(),this.writeBuffer=this.renderTarget1,this.readBuffer=this.renderTarget2}setSize(e,t){this._width=e,this._height=t;let n=this._width*this._pixelRatio,r=this._height*this._pixelRatio;this.renderTarget1.setSize(n,r),this.renderTarget2.setSize(n,r);for(let e=0;e<this.passes.length;e++)this.passes[e].setSize(n,r)}setPixelRatio(e){this._pixelRatio=e,this.setSize(this._width,this._height)}dispose(){this.renderTarget1.dispose(),this.renderTarget2.dispose(),this.copyPass.dispose()}},pe=class extends D{constructor(e,t,n=null,r=null,i=null){super(),this.scene=e,this.camera=t,this.overrideMaterial=n,this.clearColor=r,this.clearAlpha=i,this.clear=!0,this.clearDepth=!1,this.needsSwap=!1,this.isRenderPass=!0,this._oldClearColor=new p}render(e,t,n){let r=e.autoClear;e.autoClear=!1;let i,a;this.overrideMaterial!==null&&(a=this.scene.overrideMaterial,this.scene.overrideMaterial=this.overrideMaterial),this.clearColor!==null&&(e.getClearColor(this._oldClearColor),e.setClearColor(this.clearColor,e.getClearAlpha())),this.clearAlpha!==null&&(i=e.getClearAlpha(),e.setClearAlpha(this.clearAlpha)),this.clearDepth==1&&e.clearDepth(),e.setRenderTarget(this.renderToScreen?null:n),this.clear===!0&&e.clear(e.autoClearColor,e.autoClearDepth,e.autoClearStencil),e.render(this.scene,this.camera),this.clearColor!==null&&e.setClearColor(this._oldClearColor),this.clearAlpha!==null&&e.setClearAlpha(i),this.overrideMaterial!==null&&(this.scene.overrideMaterial=a),e.autoClear=r}},P={name:`LuminosityHighPassShader`,uniforms:{tDiffuse:{value:null},luminosityThreshold:{value:1},smoothWidth:{value:1},defaultColor:{value:new p(0)},defaultOpacity:{value:0}},vertexShader:`
		...
		void main() {
			...
			gl_FragColor = mix( outputColor, texel, alpha );
				...
				}`})}};F.BlurDirectionX=new T(1,0),F.BlurDirectionY=new T(0,1);var me={class:`product-page`},he={class:`model-vis-row`},I=y({__name:`ProductShowcase`,emits:[`switchModel`],setup(e,{emit:t}){let i=a(null),c,l,f,y,b,S,w,E,D,O,k,A,j,M=0,N=0,P={bursting:!1,burstStart:0,burstDuration:0,flickerSpeed:0,nextTrigger:3},I=a(0),L=a(0),R=a(1),z=a(!0),ge=a(1),B=a(!0),V=a(!0),H=a(1),U=a(1),W=a(`#64dcff`),G=a(`#64dcff`),_e=new g,K,q,ve=[],J,Y,X;function ye(){B.value=!B.value,k&&(k.visible=B.value),xe()}function be(){V.value=!V.value,j&&(j.visible=V.value),xe()}function xe(){let e=0;B.value&&e++,V.value&&e++,R.value=e}function Z(e,t){e!==void 0&&(H.value=e),t!==void 0&&(W.value=t);let n=H.value,r=t||W.value;if(A){if(A.backLight){let e=new p(r);A.backLight.style.opacity=.75*n,A.backLight.style.background=`linear-gradient(135deg, rgba(${e.r*255|0},${e.g*255|0},${e.b*255|0},${.35*n}), rgba(${e.r*255|0},${e.g*255|0},${e.b*255|0},${.2*n}))`,A.backLight.style.boxShadow=`0 0 120px rgba(${e.r*255|0},${e.g*255|0},${e.b*255|0},${.5*n}), inset 0 0 100px rgba(${e.r*255|0},${e.g*255|0},${e.b*255|0},${.35*n})`}if(A.frontGlow){let e=new p(r);A.frontGlow.style.opacity=.35*n,A.frontGlow.style.background=`linear-gradient(135deg, rgba(${e.r*255|0},${e.g*255|0},${e.b*255|0},${.15*n}), rgba(${e.r*255|0},${e.g*255|0},${e.b*255|0},${.08*n}))`,A.frontGlow.style.boxShadow=`inset 0 0 80px rgba(${e.r*255|0},${e.g*255|0},${e.b*255|0},${.2*n})`}}}function Q(e,t){e!==void 0&&(U.value=e),t!==void 0&&(G.value=t);let n=U.value,r=new p(t||G.value),i=r.r*255|0,a=r.g*255|0,o=r.b*255|0,s=`rgba(${i},${a},${o}`;document.documentElement.style.setProperty(`--gr`,i),document.documentElement.style.setProperty(`--gg`,a),document.documentElement.style.setProperty(`--gb`,o),K&&(K.style.borderColor=`${s},${.9*n})`,K.style.boxShadow=`0 0 ${20*n}px ${s},${.8*n}), 0 0 ${60*n}px ${s},${.5*n}), 0 0 ${100*n}px ${s},${.3*n}), inset 0 0 ${15*n}px ${s},${.5*n}), inset 0 0 ${50*n}px ${s},${.2*n})`),q&&(q.style.background=`radial-gradient(circle, ${s},${.35*n}) 0%, ${s},${.1*n}) 40%, transparent 70%)`),ve.forEach((e,t)=>{let r=[.15,.1,.08,.08,.12,.12];e.style.background=`${s},${r[t]||.1})`,e.style.borderColor=`${s},${.3*n})`,e.style.boxShadow=`inset 0 0 20px ${s},${.1*n})`}),J&&(J.style.borderColor=`${s},${.15*n})`,J.style.boxShadow=`0 0 ${30*n}px ${s},${.3*n}), inset 0 0 ${20*n}px ${s},${.1*n})`),Y&&(Y.style.color=`${s},${.4*n})`),X&&(X.style.borderColor=`${s},${.15*n})`)}function Se(){Z(1,`#64dcff`),Q(1,`#64dcff`)}function Ce(e){z.value=e,S&&(S.autoRotate=e)}function we(e){ge.value=e,S&&(S.autoRotateSpeed=e*1.5)}function Te(e){(e.key===` `||e.code===`Space`)&&(e.preventDefault(),z.value=!z.value,S&&(S.autoRotate=z.value))}r(()=>{Ee(),$(),window.addEventListener(`keydown`,Te)}),le(()=>{window.removeEventListener(`keydown`,Te),w&&cancelAnimationFrame(w),w&&cancelAnimationFrame(w),S?.dispose(),f?.dispose(),y?.domElement?.parentNode&&y.domElement.parentNode.removeChild(y.domElement),f?.domElement?.parentNode&&f.domElement.parentNode.removeChild(f.domElement)});function Ee(){let e=i.value,t=e.clientWidth,r=e.clientHeight;c=new m,c.background=new p(657930),l=new ae(50,t/r,1,5e3),l.position.set(0,0,800),f=new ue({antialias:!0,alpha:!0}),f.setSize(t,r),f.setPixelRatio(Math.min(window.devicePixelRatio,2)),f.domElement.style.position=`absolute`,f.domElement.style.top=`0`,f.domElement.style.pointerEvents=`none`,e.appendChild(f.domElement),y=new ne,y.setSize(t,r),y.domElement.style.position=`absolute`,y.domElement.style.top=`0`,e.appendChild(y.domElement),S=new de(l,y.domElement),S.enableDamping=!0,S.dampingFactor=.05,S.autoRotate=!0,S.autoRotateSpeed=1.5,A=De(),k=new x(A),k.position.set(-250,0,0),c.add(k),j=new x(Oe()),j.position.set(280,0,0),c.add(j);let a=new T,o=[{obj:k,pos:new n(-250,0,0)},{obj:j,pos:new n(280,0,0)}];y.domElement.addEventListener(`click`,e=>{let t=y.domElement.getBoundingClientRect();a.x=(e.clientX-t.left)/t.width*2-1,a.y=-((e.clientY-t.top)/t.height)*2+1;let r=new n,i=null,s=1/0;for(let e of o){if(!e.obj.visible)continue;e.obj.getWorldPosition(r);let t=r.clone().project(l);if(t.z>1||t.z<-1)continue;let n=t.x-a.x,o=t.y-a.y,c=n*n+o*o;c<s&&(s=c,i=e)}if(i&&s<.02){let e=i.obj.rotation.y,t=0;function n(){t+=.05,t<=1&&(i.obj.rotation.y=e+Math.PI*Ae(t),requestAnimationFrame(n))}n();let r=B.value&&!V.value,a=!B.value&&V.value;r?S.target.set(-250,0,0):a?S.target.set(280,0,0):S.target.set(0,0,0)}});let s=new Float32Array(600);for(let e=0;e<600;e+=3)s[e]=(Math.random()-.5)*2e3,s[e+1]=(Math.random()-.5)*2e3,s[e+2]=(Math.random()-.5)*1e3;let g=new d;g.setAttribute(`position`,new se(s,3)),E=new u(g,new ce({color:6605055,size:3,transparent:!0,opacity:.6,blending:2})),c.add(E),c.add(new re(4210752,2)),D=new h(6605055,2,1e3),D.position.set(200,200,200),c.add(D),O=new h(16737480,2,1e3),O.position.set(-200,-200,200),c.add(O),b=new fe(f),b.addPass(new pe(c,l)),b.addPass(new F(new T(t,r),1.5,.4,.85)),document.addEventListener(`mousemove`,ke)}function De(){let e=document.createElement(`div`);e.className=`product-card`,e.style.cssText=`width:300px;height:400px;position:relative;transform-style:preserve-3d;`,[{name:`front`,css:`translateZ(20px)`,html:`
  ...
  `,e.appendChild(l),e.appendChild(c),K=c,q=l;let u=document.createElement(`div`);u.className=`inner-cube`,u.style.cssText=`position:absolute;width:80px;height:80px;top:${320/2}px;left:${120/2}px;transform-style:preserve-3d;animation:cubeFloat 3s ease-in-out infinite;`;let d=[{css:`translateZ(40px)`,bg:`rgba(100,200,255,0.15)`},{css:`rotateY(180deg) translateZ(40px)`,bg:`rgba(100,200,255,0.1)`},{css:`rotateY(90deg) translateZ(40px)`,bg:`rgba(100,200,255,0.08)`},{css:`rotateY(-90deg) translateZ(40px)`,bg:`rgba(100,200,255,0.08)`},{css:`rotateX(90deg) translateZ(40px)`,bg:`rgba(100,200,255,0.12)`},{css:`rotateX(-90deg) translateZ(40px)`,bg:`rgba(100,200,255,0.12)`}],f=[];d.forEach(e=>{let t=document.createElement(`div`);t.style.cssText=`position:absolute;width:80px;height:80px;backface-visibility:visible;border:1px solid rgba(100,220,255,0.3);transform:${e.css};background:${e.bg};box-shadow:inset 0 0 20px rgba(100,220,255,0.1);animation:cubeGlow 2s ease-in-out infinite;`,u.appendChild(t),f.push(t)}),e.appendChild(u),ve=f;let p=document.createElement(`div`);p.style.cssText=`position:absolute;width:200px;height:200px;transform:rotateX(-90deg) translateZ(300px);background:linear-gradient(135deg,#1a1a2e,#2a1a3e);border:1px solid rgba(100,200,255,0.15);border-radius:4px;box-shadow:0 0 30px rgba(100,200,255,0.3),inset 0 0 20px rgba(100,200,255,0.1);animation:breatheLight 2s ease-in-out infinite;display:flex;align-items:center;justify-content:center;`;let m=document.createElement(`span`);m.style.cssText=`font-size:10px;color:rgba(100,200,255,0.4);text-align:center;line-height:1.4;pointer-events:none;`,p.appendChild(m),e.appendChild(p),J=p,Y=m;let h=document.createElement(`div`);return h.style.cssText=`position:absolute;width:500px;height:500px;border:2px solid rgba(100,200,255,0.15);border-radius:50%;top:50%;left:50%;transform:translate(-50%,-50%) rotateX(75deg);animation:orbit 12s linear infinite;pointer-events:none;`,e.appendChild(h),X=h,e}function ke(e){let t=e.clientX/window.innerWidth*2-1,n=-(e.clientY/window.innerHeight)*2+1;A&&(A.style.transform=`rotateX(${-n*15}deg) rotateY(${t*15}deg)`),D&&(D.position.x=t*500,D.position.y=n*500)}function Ae(e){return 1-(1-e)**3}function $(){w=requestAnimationFrame($);let e=_e.getElapsedTime();M++,N===0&&(N=performance.now());let t=performance.now();if(t-N>=1e3&&(I.value=M,M=0,N=t,window.performance?.memory&&(L.value=window.performance.memory.usedJSHeapSize)),S.update(),E&&(E.rotation.y=e*.05,E.rotation.x=e*.02),k&&(k.position.y=Math.sin(e)*20),j&&(j.position.y=Math.sin(e)*20),D&&(D.intensity=2+Math.sin(e*2)*.5),O&&(O.intensity=2+Math.cos(e*2.3)*.5),A&&A.backLight)if(!P.bursting&&e>P.nextTrigger&&(P.bursting=!0,P.burstStart=e,P.burstDuration=.2+Math.random()*3,P.flickerSpeed=20+Math.random()*50,P.nextTrigger=e+6+Math.random()*6),P.bursting){let t=e-P.burstStart;if(t<P.burstDuration){let e=Math.sin(t*P.flickerSpeed)*.4+Math.sin(t*(P.flickerSpeed*.53))*.3+Math.sin(t*(P.flickerSpeed*.17))*.2+Math.random()*.25>.3;A.backLight.style.opacity=e?.75*H.value:.05+Math.random()*.1,A.frontGlow&&(A.frontGlow.style.opacity=e?.35*H.value:.02+Math.random()*.04)}else P.bursting=!1}else A.backLight.style.opacity=.75*H.value,A.frontGlow&&(A.frontGlow.style.opacity=.35*H.value);b&&b.render(),y&&y.render(c,l)}return(e,t)=>(s(),ie(`div`,me,[ee(te,null,{header:_(()=>[...t[4]||=[C(`h2`,null,`📦 CSS3D 产品展示`,-1),C(`p`,null,[C(`strong`,null,`核心展示：`),v(`6 面 CSS3D 产品卡片 + WebGL 粒子光效，双渲染器（CSS3D + WebGL）叠加。`)],-1)]]),default:_(()=>[t[6]||=C(`div`,{class:`info-grid`},[C(`div`,{class:`info-section`},[C(`div`,{class:`info-section-title`},`🎮 鼠标操作`),C(`div`,{class:`info-item`},[C(`kbd`,null,`拖拽`),v(` 旋转视角`)]),C(`div`,{class:`info-item`},[C(`kbd`,null,`滚轮`),v(` 缩放画面`)]),C(`div`,{class:`info-item`},[C(`kbd`,null,`移动鼠标`),v(` 卡片倾斜`)])]),C(`div`,{class:`info-section`},[C(`div`,{class:`info-section-title`},`✨ 效果`),C(`div`,{class:`info-item`},`Bloom 辉光后期`),C(`div`,{class:`info-item`},`双点光源脉冲`),C(`div`,{class:`info-item`},`200 粒子系统`)])],-1),C(`div`,he,[t[5]||=C(`span`,{class:`model-vis-label`},`🎯 模型显示：`,-1),C(`button`,{class:o([`model-toggle`,{active:B.value}]),onClick:ye},`📦 产品卡片`,2),C(`button`,{class:o([`model-toggle`,{active:V.value}]),onClick:be},`🗄️ 玻璃展柜`,2)])]),_:1}),ee(oe,{fps:I.value,memory:L.value,objectCount:R.value,cardBrightness:H.value,glassBrightness:U.value,cardColor:W.value,glassColor:G.value,onTogglePlay:Ce,onUpdateSpeed:we,onUpdateCardBrightness:t[0]||=e=>Z(e,void 0),onUpdateGlassBrightness:t[1]||=e=>Q(e,void 0),onUpdateCardColor:t[2]||=e=>Z(void 0,e),onUpdateGlassColor:t[3]||=e=>Q(void 0,e),onResetLights:Se},null,8,[`fps`,`memory`,`objectCount`,`cardBrightness`,`glassBrightness`,`cardColor`,`glassColor`]),C(`div`,{ref_key:`containerRef`,ref:i,class:`canvas-container`},null,512)]))}},[[`__scopeId`,`data-v-e0c9a753`]]);export{I as default};