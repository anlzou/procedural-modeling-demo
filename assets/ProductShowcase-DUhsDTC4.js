import{An as e,B as t,Bn as n,Cr as r,P as i,Pr as a,Rr as o,Tr as s,Un as c,_n as l,_t as u,d,ft as f,g as p,gn as m,gt as h,h as g,hr as _,i as ee,jr as v,mr as y,n as te,nr as b,nt as x,o as ne,pr as re,pt as S,r as C,t as w,tt as T,u as ie,ur as E,vt as ae,wn as D,xr as oe,zn as O}from"./CSS3DRenderer-CQg2YHRj.js";import{n as k,t as A}from"./OrbitControls-CVb_478F.js";var j={name:`CopyShader`,uniforms:{tDiffuse:{value:null},opacity:{value:1}},vertexShader:`
  ...
  `,e.appendChild(c),e.appendChild(s);let l=document.createElement(`div`);l.className=`inner-cube`,l.style.cssText=`position:absolute;width:80px;height:80px;top:${320/2}px;left:${120/2}px;transform-style:preserve-3d;animation:cubeFloat 3s ease-in-out infinite;`,[{css:`translateZ(40px)`,bg:`rgba(100,200,255,0.15)`},{css:`rotateY(180deg) translateZ(40px)`,bg:`rgba(100,200,255,0.1)`},{css:`rotateY(90deg) translateZ(40px)`,bg:`rgba(100,200,255,0.08)`},{css:`rotateY(-90deg) translateZ(40px)`,bg:`rgba(100,200,255,0.08)`},{css:`rotateX(90deg) translateZ(40px)`,bg:`rgba(100,200,255,0.12)`},{css:`rotateX(-90deg) translateZ(40px)`,bg:`rgba(100,200,255,0.12)`}].forEach(e=>{let t=document.createElement(`div`);t.style.cssText=`position:absolute;width:80px;height:80px;backface-visibility:visible;border:1px solid rgba(100,220,255,0.3);transform:${e.css};background:${e.bg};box-shadow:inset 0 0 20px rgba(100,220,255,0.1);animation:cubeGlow 2s ease-in-out infinite;`,l.appendChild(t)}),e.appendChild(l);let u=document.createElement(`div`);u.style.cssText=`position:absolute;width:200px;height:200px;transform:rotateX(-90deg) translateZ(300px);background:linear-gradient(135deg,#1a1a2e,#2a1a3e);border:1px solid rgba(100,200,255,0.15);border-radius:4px;box-shadow:0 0 30px rgba(100,200,255,0.3),inset 0 0 20px rgba(100,200,255,0.1);animation:breatheLight 2s ease-in-out infinite;display:flex;align-items:center;justify-content:center;`,u.innerHTML=`<span style="font-size:10px;color:rgba(100,200,255,0.4);text-align:center;line-height:1.4;">手办<br>展示</span>`,e.appendChild(u);let d=document.createElement(`div`);return d.style.cssText=`position:absolute;width:500px;height:500px;border:2px solid rgba(100,200,255,0.15);border-radius:50%;top:50%;left:50%;transform:translate(-50%,-50%) rotateX(75deg);animation:orbit 12s linear infinite;pointer-events:none;`,e.appendChild(d),e}function he(e){let t=e.clientX/window.innerWidth*2-1,n=-(e.clientY/window.innerHeight)*2+1;F&&(F.style.transform=`rotateX(${-n*15}deg) rotateY(${t*15}deg)`),M&&(M.position.x=t*500,M.position.y=n*500)}function ge(e){return 1-(1-e)**3}function $(){D=requestAnimationFrame($);let e=ce.getElapsedTime();L++,R===0&&(R=performance.now());let t=performance.now();t-R>=1e3&&(V.value=L,L=0,R=t,window.performance?.memory&&(G.value=window.performance.memory.usedJSHeapSize)),T.update(),j&&(j.rotation.y=e*.05,j.rotation.x=e*.02),P&&(P.position.y=Math.sin(e)*20),I&&(I.position.y=Math.sin(e)*20),M&&(M.intensity=2+Math.sin(e*2)*.5),N&&(N.intensity=2+Math.cos(e*2.3)*.5),x&&x.render(),b&&b.render(c,l)}return(e,t)=>(s(),re(`div`,U,[_(ee,null,{header:v(()=>[...t[0]||=[E(`h2`,null,`📦 CSS3D 产品展示`,-1),E(`p`,null,[E(`strong`,null,`核心展示：`),y(`6 面 CSS3D 产品卡片 + WebGL 粒子光效，双渲染器（CSS3D + WebGL）叠加。`)],-1)]]),default:v(()=>[t[2]||=E(`div`,{class:`info-grid`},[E(`div`,{class:`info-section`},[E(`div`,{class:`info-section-title`},`🎮 鼠标操作`),E(`div`,{class:`info-item`},[E(`kbd`,null,`拖拽`),y(` 旋转视角`)]),E(`div`,{class:`info-item`},[E(`kbd`,null,`滚轮`),y(` 缩放画面`)]),E(`div`,{class:`info-item`},[E(`kbd`,null,`移动鼠标`),y(` 卡片倾斜`)])]),E(`div`,{class:`info-section`},[E(`div`,{class:`info-section-title`},`✨ 效果`),E(`div`,{class:`info-item`},`Bloom 辉光后期`),E(`div`,{class:`info-item`},`双点光源脉冲`),E(`div`,{class:`info-item`},`200 粒子系统`)])],-1),E(`div`,W,[t[1]||=E(`span`,{class:`model-vis-label`},`🎯 模型显示：`,-1),E(`button`,{class:o([`model-toggle`,{active:J.value}]),onClick:le},`📦 产品卡片`,2),E(`button`,{class:o([`model-toggle`,{active:Y.value}]),onClick:ue},`🗄️ 玻璃展柜`,2)])]),_:1}),_(C,{fps:V.value,memory:G.value,objectCount:K.value,onTogglePlay:de,onUpdateSpeed:Z},null,8,[`fps`,`memory`,`objectCount`]),E(`div`,{ref_key:`containerRef`,ref:i,class:`canvas-container`},null,512)]))}},[[`__scopeId`,`data-v-5beff07f`]]);export{G as default};